...
$r=mysql_fetch_array(mysql_query("SELECT * FROM users WHERE id_users='$_SESSION[id_user]'"));
...
if ($pass_lama==$r[password]){
  ...
  if ($_POST[pass_baru]==$_POST[pass_ulangi]){
    mysql_query("UPDATE users SET password = '$pass_baru' WHERE id_users='$_SESSION[id_user]'");
