		...
		<div class="row-fluid sortable">
			<div class="box span12">
				<div class="box-header well" data-original-title>
					<h2><i class="icon-file"></i> Artikel</h2>
					<div class="box-icon">
				...
				<div class="box-content">
					<input type=button value=\'Tambah Artikel\' class="btn btn-primary" 
					onclick="window.location.href=\'?module=artikel&act=tambahartikel\';"><br /><br />
	...
	';
							...
							while($r=mysql_fetch_array($tampil)){
								...
								<tr>
									...
									<td>$r[judul]</td>
									<td>
										<a class=\"btn btn-info\" href=?module=artikel&act=editartikel&id=$r[id_artikel]><i class=\"icon-edit icon-white\"></i> Edit</a> 
										<a class=\"btn btn-danger\" href='$aksi?module=artikel&act=hapus&id=$r[id_artikel]&namafile=$r[gambar]'><i class=\"icon-trash icon-white\"></i> Hapus</a>
									</td>
								</tr>
								";
								$no++;
    ...
    echo '
		<div>
			<ul class="breadcrumb">
				...
				<li>
					<a href="?module=artikel">Artikel</a> <span class="divider">/</span>
				</li>
				<li>
		...
		<div class="row-fluid sortable">
			<div class="box span12">
				<div class="box-header well" data-original-title>
					<h2><i class="icon-plus-sign"></i> Tambah Artikel</h2>
					<div class="box-icon">
						<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
						<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
					</div>
				...
				<div class="box-content">
					<form class="form-horizontal" method=POST action='.$aksi.'?module=artikel&act=input enctype=\'multipart/form-data\'>
						<fieldset>
  ...
  case "editartikel":
    ...
    echo '
		...
		<div class="row-fluid sortable">
			<div class="box span12">
				<div class="box-header well" data-original-title>
					<h2><i class="icon-edit"></i> Edit Artikel</h2>
					<div class="box-icon">
						<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
						<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a>
					</div>
				...
				<div class="box-content">
					<form class="form-horizontal" method=POST enctype=\'multipart/form-data\' action='.$aksi.'?module=artikel&act=update>
						<fieldset>
