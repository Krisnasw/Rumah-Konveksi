		...
		<div class="row-fluid sortable">
			<div class="box span12">
				...
				<div class="box-content">
					...
					onclick="window.location.href=\'?module=kategoriproduk&act=tambahkategoriproduk\';"><br /><br />
	...
	';
						...
						while ($r=mysql_fetch_array($tampil)){
							...
							<tr>
								...
								<td>
									<a class=\"btn btn-info\" href=?module=kategoriproduk&act=editkategoriproduk&id=$r[id_kategori]><i class=\"icon-edit icon-white\"></i> Edit</a>
									<a class=\"btn btn-danger\" href=$aksi?module=kategoriproduk&act=hapus&id=$r[id_kategori]><i class=\"icon-trash icon-white\"></i> Hapus</a>
								</td>
							</tr>
							";
							$no++;
    ...
    echo '
		<div>
			<ul class="breadcrumb">
				...
				<li>
					<a href="?module=kategoriproduk">Kategori</a> <span class="divider">/</span>
				</li>
				<li>
		...
		<div class="row-fluid sortable">
			<div class="box span12">
				...
				<div class="box-content">
					<form class="form-horizontal" method=POST action='.$aksi.'?module=kategoriproduk&act=input enctype=\'multipart/form-data\'>
						<fieldset>
    ...
    echo '
		...
		<div class="row-fluid sortable">
			<div class="box span12">
				...
				<div class="box-content">
					<form class="form-horizontal" method=POST action='.$aksi.'?module=kategoriproduk&act=update enctype=\'multipart/form-data\'>
						<fieldset>
							...
							<div class="control-group">
								...
								<div class="controls">
									<div class="fileupload-new thumbnail" style="max-width: 180px;">
										<img src="../files/'.$r['gambar'].'" style="width: 180px;" />
									</div>
									<input type=file name="fupload" />
								</div>
							</div>
